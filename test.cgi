...
<div class="side-list" style="margin-top:30px;">
  ...
  <div class="inside">
    DBIx::Customは、<a href="https://perlzemi.com/">Perl</a>のデータベースアクセスモジュールの一つです。insert,update,delete,selectのSQLを簡単に実行できる機能があります。DBIx::Connectorをデフォルトで搭載、接続管理も自動的に行います。where句のand,orを柔軟に書け、プレイスホルダー機能を提供。<a href="https://webapp.perlzemi.com/">Webシステム開発</a>では、外部キーのjoinを頻繁に記述しますが、join句をモデルに定義して、簡単に外部キーを接続できます。<a href="https://mariadb.perlclub.net/">MariaDB</a>, MySQL, PostgreSQL, SQLite, Microsoft SQL Server, Oracle Database, Microsoft Accessにも対応。
  </div>
</div>

<div class="perlri_link">
  <a href="https://perlclub.net">
    プログラミングスクール<br>Perlクラブ
  </a>
</div>
