...
<div class="main">
  <h1>
    <a href="/">DBIx::Custom - SQLの実行が簡単なPerlのO/Rマッパー</a>
  </h1>
</div>
...
<div class="side-list">
  ...
  <ul>
    ...
    <li><a href="/blog/20110708131364.html">execute - 任意のSQLの実行</a></li>
    <li><a href="/blog/20110924132031.html">where - 任意の条件の作成</a></li>
    <li><a href="/blog/20110709131364.html">行をフェッチする</a></li>
    <li><a href="/blog/20200127081842.html">その他の機能</a></li>
      ...
      <div class="footer">
        <!-- footer -->
<a href="https://github.com/yuki-kimoto/giblog">This site is Created by Giblog</a>
